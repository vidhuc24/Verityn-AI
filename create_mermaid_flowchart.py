#!/usr/bin/env python3
"""
Create Verityn AI Application Flowchart (Mermaid Version)
Generates a Mermaid flowchart that can be converted to PNG/JPEG using online renderers.
"""
...
def create_detailed_mermaid_flowchart():
    mermaid_code = """
graph TB
    %% Title
    ...
    subgraph "User Interface Layer"
        ...
        B[🖥️ Next.js Frontend<br/>• Document Upload<br/>• Chat Interface<br/>• Smart Questions<br/>• Progress Feedback]
    ...
    subgraph "Multi-Agent Workflow"
        ...
        E[🏷️ Classification Agent<br/>• Identify Type<br/>• SOX Controls<br/>• Risk Level<br/>• Compliance Framework]
        ...
        I[⚖️ Compliance Analyzer Agent<br/>• Risk Assessment<br/>• Compliance Validation<br/>• Control Mapping]
    end
    ...
    subgraph "Advanced Retrieval Techniques"
        ...
        J4[🏷️ Metadata Filtering<br/>Type, Framework, Risk]
    ...
    subgraph "Data Processing Layer"
        K[✂️ Document Chunking<br/>• 1000-char chunks<br/>• 250-char overlap<br/>• Preserve Structure]
        L[🧠 Embedding Generation<br/>• OpenAI text-embedding-3-small<br/>• Semantic Vectors<br/>• High Quality]
        M[🗄️ Vector Database - Qdrant<br/>• Similarity Search<br/>• Fast Retrieval<br/>• Metadata Storage]
...
if __name__ == "__main__":
    ...
    simple_mermaid = create_mermaid_flowchart()
    with open('verityn_ai_flowchart_simple.mmd', 'w') as f:
        f.write(simple_mermaid)
    
    # Create detailed version
    detailed_mermaid = create_detailed_mermaid_flowchart()
    with open('verityn_ai_flowchart_detailed.mmd', 'w') as f:
        f.write(detailed_mermaid)
    
    print("✅ Mermaid flowcharts generated successfully!")
    print("📁 Files created:")
    print("   - verityn_ai_flowchart_simple.mmd")
    print("   - verityn_ai_flowchart_detailed.mmd")
    print("\n💡 To convert to PNG/JPEG:")
    print("   1. Go to https://mermaid.live/")
    print("   2. Paste the .mmd file content")
    print("   3. Click 'Download PNG' or 'Download SVG'")
    print("   4. Or use: https://mermaid.ink/")
